...
class BikeRentalTest(unittest.TestCase):
    ...
    def test_rentBikeOnDailyBasis_for_invalid_positive_number_of_bikes(self):
        print("\nRent Bike Daily Not enough stock !")
        shop = BikeRental(10)
